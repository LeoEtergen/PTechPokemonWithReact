...
import pokemonService, { IPokemon, IEvolution } from '../../services/PokemonService';
...
export const Pokemon = () => {
    ...
    return (
        <>
            ...
            {
                //Boolean (pokemon.evolutions.lenght) &&
                //pokemon.evolutions.lenght == true &&
                            ...
                            return (
                                <div className="evolutions__item">
                                    ...
                                    <div className="evolutions__details">
                                        ...
                                        <p className="evolutions__level">{evolution.level}</p>
                                    </div>
                                </div>
                                );
                        })
